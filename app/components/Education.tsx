  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row flex-wrap justify-around items-center max-w-[900px] mx-auto">
        <div className="flex  flex-col justify-between items-center pt-2 mt-5 text-lg">
        ...
        <p className="text-gray-300 pt-5 text-center text-lg">
          ...
          devant vos yeux 👀 grâce à ce site. 
        </p>
        ...
        <div className="flex  flex-col justify-between items-center pt-5 mt-10 text-lg">
          <p className="text-gray-300  text-center pb-2">
            <span className="font-semibold">IDRAC Business School / </span>{" "}
            Bachelor Responsable Marketing et Développement Commercial
          </p>
          <p className=" font-bold text-transparent pb-2  bg-clip-text bg-gradient-to-r from-purple-700 to-orange-500  text-1xl">
            2015 - 2017
          </p>
        </div>
        <div className="flex-row flex-wrap flex justify-center sm:flex-row ">
